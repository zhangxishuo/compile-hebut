...
public class LexicalAnalysis {
    ...
    public static Symbol getSymbol(char i, int row, int col) {
        ...
        if (i >= '0' && i <= '9') {
            ...
            symbol.setSymbolType(SymbolType.LEFT_BRACKET);
        } else if (i == ')') {
            symbol.setSymbolType(SymbolType.RIGHT_BRACKET);
        } else {
        ...
        switch (currentState) {
            ...
            case 0:
                ...
                switch (symbolType) {
                    ...
                    case LEFT_BRACKET:
                        word = new Word(currentLocation);
                        word.setType(Type.LEFT_BRACKET);
                        wordList.add(word);
                        break;

                    case RIGHT_BRACKET:
                        word = new Word(currentLocation);
                        word.setType(Type.RIGHT_BRACKET);
                        wordList.add(word);
                        break;
